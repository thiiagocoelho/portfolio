export const meusProjetos = [
    {
        id: 1,
        titulo: "Green House",
        descricao: "Landing page desenvolvida para um projeto fictício de uma empresa de jardinagem chamada Green House. O objetivo é apresentar os serviços da empresa de forma clara e atraente, utilizando um design responsivo e acessível.",
        tecnologias: [
            { nome: 'HTML5', icone: 'fab fa-html5' },
            { nome: 'CSS3', icone: 'fab fa-css3-alt' },
            { nome: 'JavaScript', icone: 'fab fa-js-square' },
            { nome: 'Figma', imagemIcone: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Figma-logo.svg/256px-Figma-logo.svg.png' }
        ],
        linkOnline: "https://green-house-thk.netlify.app/",
        imagensGaleria: [
            "../paginaProjetos/imgProjetos/Captura de tela 2025-07-08 115308.png",
            "../paginaProjetos/imgProjetos/Captura de tela 2025-07-09 095146.png",
            "../paginaProjetos/imgProjetos/Captura de tela 2025-07-09 095211.png"
        ]
    },
    {
        id: 2,
